...
const articles = {
    1: {
        ...
        content: `
            ...
            <p>Write to me for your comments</p>
        `
    },
    2: {
...
We will explore this process further through an example in the following section.</p>
    ...
    3: {
        ...
        content: `
            <h2>Remember</h2>
            <p>Remember when you were four
eyes’ longing to know more,
radiant smile, vibrant mind,
curious and kind;
Remember and find
Now, finger on lips, head down;
ask questions and I’m a foal,
just stories and ideas, loosing
the fresh air; help if you’ve any tool,</p>
            ...
            <p>**Conclusion:**
The poem closes by contrasting the openness and wonder of childhood with the hesitance and confinement of later inquiry. It suggests that true understanding is not found in the accumulation of stories or tools alone, but in recovering the freshness, courage, and simplicity of asking freely and engaging directly with the world.
</p>
        `
    }
};
